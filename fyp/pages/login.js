                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onBlur={onFocus}
                      focused={Focus}
                      className=" infoInputs block w-full bg-slate-50 appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                    />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    type="checkbox"
                    className="h-4 w-4 rounded via-gray-400 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                  />
                  <label
                    htmlFor="remember-me"
