            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        refVarient(
                          Object.keys(varients[e.target.value]),
                          e.target.value
                        )
                      }
                      className="rounded border border-gray-700 focus:ring-2 focus:ring-green-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-green-500 text-gray-400 pl-3 pr-10"
                    >
                      {Object.keys(varients).includes("S") && (
                        <option value={"S"}>S</option>
                      )}
                      {Object.keys(varients).includes("M") && (
                        <option value={"M"}>M</option>
                      )}
                      {Object.keys(varients).includes("L") && (
                        <option value={"L"}>L</option>
                      )}
                      {Object.keys(varients).includes("XL") && (
                        <option value={"XL"}>XL</option>
                      )}
                      {Object.keys(varients).includes("XXL") && (
              ...
              {product.availableQty > 0 ? (
                <div className="flex flex-wrap">
                  ...
                  <button
                    ref={heart}
                    onClick={like}
                    className="rounded-full w-10 h-10 bg-gray-800 p-0 border-0 inline-flex items-center justify-center text-gray-500 md:ml-4 ml-2"
                  >
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
              ...
              <div className="pincode flex space-x-2 text-sm mt-6">
                <input
                  ...
                  className="px-2 text-black rounded-md border-green-700 focus:outline-none focus:border-green-300 border-2"
                  type="text"
                />
                <button
              ...
              {!Service && Service != null && Service !== "Empty" && (
