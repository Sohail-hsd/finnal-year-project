...
const Orders = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-auto relative shadow-md sm:rounded-lg bg-gray-900">
      ...
      <h1 className="text-center my-4 text-5xl font-bold leading-tight text-white">
        Your Orders
      </h1>
        ...
        <tbody>
          ...
          {myOrders.map((item) => (
            ...
            >
              ...
              <td className="py-4 px-6">PKR {item.amount.toFixed(2)}</td>
              <td
                className={`py-4 px-6 ${
                  item.status === "Pending"
                    ? "text-yellow-400"
              ...
              >
                <span className="hover:bg-slate-900 p-1 rounded-lg">
                  {item.status}
                </span>
              </td>
              <td
                className={`py-4 px-6 ${
                  item.deliveryStatus === "unshipped"
                    ? "text-yellow-400"
                    : "text-green-400"
                }`}
              >
